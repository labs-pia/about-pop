...
function about_pop_scripts() {
	...
	wp_enqueue_style( 'jquery.mobile-style', get_template_directory_uri() . '/js/jquery.mobile-1.4.5.min.css',array(), '1.4.5.', 'all' );
	...
	wp_enqueue_script('jquery.mobile-js', get_template_directory_uri() . '/js/jquery.mobile-1.4.5.min.js', array('jquery-js'), '1.4.5.', false);
