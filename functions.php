...
if ( ! function_exists( 'pop_buero_custom_wp_trim_excerpt' ) ) : 
    ...
    $raw_excerpt = $excerptt;
        if ( '' == $excerpt ) {
            ...
            $excerpt = strip_tags($excerpt, pop_buero_allowedtags()); /*IF you need to allow just certain tags. Delete if all tags are allowed */
        ...
        return apply_filters('pop_buero_custom_wp_trim_excerpt', $excerpt, $raw_excerpt);
    }
